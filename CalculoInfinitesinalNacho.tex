...
\usepackage[top=3.1cm, bottom=3.1cm, left=3.5cm, right=2.5cm]{geometry} % márgenes (para encuadernado-book: impares más a la izquda, pares más a la dcha.
...
%\includeonly{TEMA08_chapter} %para ver solo esto, o separado por comas, varios
